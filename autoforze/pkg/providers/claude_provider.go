...
import (
	...
	anthropicprovider "github.com/sipeed/autoforze/pkg/providers/anthropic"
)
...
func createClaudeTokenSource() func() (string, error) {
	return func() (string, error) {
		...
		if cred == nil {
			return "", fmt.Errorf("no credentials for anthropic. Run: autoforze auth login --provider anthropic")
		}
