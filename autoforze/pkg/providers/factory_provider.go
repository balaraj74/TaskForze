...
import (
	...
	anthropicmessages "github.com/sipeed/autoforze/pkg/providers/anthropic_messages"
	"github.com/sipeed/autoforze/pkg/providers/azure"
	"github.com/sipeed/autoforze/pkg/providers/bedrock"
)
...
func createClaudeAuthProvider() (LLMProvider, error) {
	...
	if cred == nil {
		return nil, fmt.Errorf("no credentials for anthropic. Run: autoforze auth login --provider anthropic")
	}
...
func createCodexAuthProvider() (LLMProvider, error) {
	...
	if cred == nil {
		return nil, fmt.Errorf("no credentials for openai. Run: autoforze auth login --provider openai")
	}
...
func CreateProviderFromConfig(cfg *config.ModelConfig) (LLMProvider, string, error) {
	...
	if userAgent == "" {
		userAgent = fmt.Sprintf("AutoForze/%s", config.Version)
	}
