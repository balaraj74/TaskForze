...
import (
	...
	orc "github.com/sipeed/autoforze/pkg/providers/openai_responses_common"
)
...
func createCodexTokenSource() func() (string, string, error) {
	return func() (string, string, error) {
		...
		if cred == nil {
			return "", "", fmt.Errorf("no credentials for openai. Run: autoforze auth login --provider openai")
		}
