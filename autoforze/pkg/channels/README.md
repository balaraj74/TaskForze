# AutoForze Channel System: Complete Development Guide

> **Scope**: `pkg/channels/`, `pkg/bus/`, `pkg/media/`, `pkg/identity/`, `cmd/autoforze/internal/gateway/`
...
import (
    "github.com/sipeed/autoforze/pkg/bus"
    "github.com/sipeed/autoforze/pkg/channels"     // Reference parent package
    "github.com/sipeed/autoforze/pkg/config"
    "github.com/sipeed/autoforze/pkg/identity"      // New
    "github.com/sipeed/autoforze/pkg/media"          // New (if media support needed)
)
```
...
```go
// cmd/autoforze/internal/gateway/helpers.go
import (
    _ "github.com/sipeed/autoforze/pkg/channels/telegram"   // Triggers init() registration
    _ "github.com/sipeed/autoforze/pkg/channels/discord"
    _ "github.com/sipeed/autoforze/pkg/channels/your_new_channel"  // New addition
)
```
...
import (
    ...
    "github.com/sipeed/autoforze/pkg/channels"
    "github.com/sipeed/autoforze/pkg/config"
    "github.com/sipeed/autoforze/pkg/identity"
...
// cmd/autoforze/internal/gateway/helpers.go
import (
    _ "github.com/sipeed/autoforze/pkg/channels/matrix"
)
```
...
4. **Pico Protocol**: `pkg/channels/pico/` implements a custom AutoForze native protocol channel that receives messages via WebSocket webhook (`/pico/ws`).
