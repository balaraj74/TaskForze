...
func TestResolveWorkspace(t *testing.T) {
	result := ResolveWorkspace("/home/user/.autoforze")
	assert.Equal(t, "/home/user/.autoforze/workspace", result)
}

func TestRelPath(t *testing.T) {
	result := RelPath("/home/user/.autoforze/workspace/file.txt", "/home/user/.autoforze")
...
func TestResolveTargetHome(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, filepath.Join(home, ".autoforze"), result)
}
