...
const (
	...
	userAgentHonest = "autoforze/%s (+https://github.com/sipeed/autoforze; AI assistant bot)"
...
func (p *SearXNGSearchProvider) Search(
	...
	// Format results in standard AutoForze format
...
func (t *WebFetchTool) Execute(ctx context.Context, args map[string]any) *ToolResult {
	...
	// Retry once with an honest User-Agent that identifies autoforze, which some
