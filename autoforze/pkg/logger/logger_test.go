...
func TestConfigureFromEnv(t *testing.T) {
	...
	tmpFile := "/tmp/autoforze_test_log_" + fmt.Sprintf("%d", time.Now().UnixNano())
	defer os.Remove(tmpFile)

	os.Setenv("AUTOFORZE_LOG_FILE", tmpFile)
	defer os.Unsetenv("AUTOFORZE_LOG_FILE")
	...
	os.Setenv("AUTOFORZE_LOG_FILE", "~/test_log")
	ConfigureFromEnv()
...
func TestConfigureFromEnvNoEnv(t *testing.T) {
	os.Unsetenv("AUTOFORZE_LOG_FILE")
	ConfigureFromEnv()
}
