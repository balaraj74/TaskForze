...
func TestParseGitHubRef(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			repo:         "sipeed/autoforze",
			wantOwner:    "sipeed",
			wantRepoName: "autoforze",
			wantRef:      "main",
			wantSubPath:  "",
		},
		{
			name:         "owner/repo with subpath",
			repo:         "sipeed/autoforze/skills/test",
			wantOwner:    "sipeed",
			wantRepoName: "autoforze",
			wantRef:      "main",
		...
		},
		{
			...
			repo:         "https://github.com/sipeed/autoforze/tree/dev/skills/test",
			wantOwner:    "sipeed",
			wantRepoName: "autoforze",
			wantRef:      "dev",
			wantSubPath:  "skills/test",
		},
		{
			...
			repo:         "https://github.com/sipeed/autoforze/blob/main/README.md",
			wantOwner:    "sipeed",
			wantRepoName: "autoforze",
			wantRef:      "main",
		...
		},
		{
			...
			repo:         "https://github.com/sipeed/autoforze",
			wantOwner:    "sipeed",
			wantRepoName: "autoforze",
			wantRef:      "main",
			wantSubPath:  "",
...
func TestSkillInstaller_InstallFromGitHub_SkillAlreadyExists(t *testing.T) {
	...
	existingSkill := filepath.Join(skillsDir, "autoforze")
	...
	err = installer.InstallFromGitHub(context.Background(), "sipeed/autoforze")
	if err == nil {
