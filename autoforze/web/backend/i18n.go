...
var translations = map[Language]map[TranslationKey]string{
	LanguageEnglish: {
		...
		MenuOpenTooltip:    "Open AutoForze console in browser",
		MenuAbout:          "About",
		MenuAboutTooltip:   "About AutoForze",
		...
		MenuQuit:           "Quit",
		MenuQuitTooltip:    "Exit AutoForze",
		Exiting:            "Exiting AutoForze...",
		DocUrl:             "https://docs.autoforze.io/docs/",
	},
	LanguageChinese: {
		AppTooltip:         "%s - Web Console",
		MenuOpen:           "打开控制台",
		MenuOpenTooltip:    "在浏览器中打开 AutoForze 控制台",
		MenuAbout:          "关于",
		MenuAboutTooltip:   "关于 AutoForze",
		MenuVersion:        "版本: %s",
		...
		MenuQuit:           "退出",
		MenuQuitTooltip:    "退出 AutoForze",
		Exiting:            "正在退出 AutoForze...",
		DocUrl:             "https://docs.autoforze.io/zh-Hans/docs/",
	},
}
