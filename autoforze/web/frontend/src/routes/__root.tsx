    ...
    void getLauncherAuthStatus()
      ...
      .catch((err: unknown) => {
        ...
        if (err instanceof Error && /^status 40[13]$/.test(err.message)) {
          ...
          setAuthError(
            err instanceof Error ? err.message : "Auth service unavailable, please try to delete the launcher-auth.db at autoforze home directory and restart the application.",
          )
        }
      })
  }, [isAuthPage])
