...
CONTAINER_NAME="autoforze-test-ergo"
IRC_PORT=6667
...
echo ""
echo "Add this to your ~/.autoforze/config.json under \"channels\":"
echo ""
echo '  "irc": {'
echo '    "enabled": true,'
...
echo '  }'
echo ""
echo "Then run autoforze:"
echo "  cd packages/autoforze && go run ./cmd/autoforze gateway"
echo ""
