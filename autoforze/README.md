<div align="center">
<img src="assets/logo.webp" alt="AutoForze" width="512">

<h1>AutoForze: Ultra-Efficient AI Assistant in Go</h1>

<h3>$10 Hardware · 10MB RAM · ms Boot · Let's Go, AutoForze!</h3>
  <p>
    <img src="https://img.shields.io/badge/Go-1.25+-00ADD8?style=flat&logo=go&logoColor=white" alt="Go">
    <img src="https://img.shields.io/badge/Arch-x86__64%2C%20ARM64%2C%20MIPS%2C%20RISC--V%2C%20LoongArch-blue" alt="Hardware">
    <img src="https://img.shields.io/badge/license-MIT-green" alt="License">
    <br>
    <a href="https://autoforze.io"><img src="https://img.shields.io/badge/Website-autoforze.io-blue?style=flat&logo=google-chrome&logoColor=white" alt="Website"></a>
    <a href="https://docs.autoforze.io/"><img src="https://img.shields.io/badge/Docs-Official-007acc?style=flat&logo=read-the-docs&logoColor=white" alt="Docs"></a>
    <a href="https://deepwiki.com/sipeed/autoforze"><img src="https://img.shields.io/badge/Wiki-DeepWiki-FFA500?style=flat&logo=wikipedia&logoColor=white" alt="Wiki"></a>
    <br>
...
> **AutoForze** is an independent open-source project initiated by [Sipeed](https://sipeed.com), written entirely in **Go** from scratch — not a fork of OpenClaw, NanoBot, or any other project.

**AutoForze** is an ultra-lightweight personal AI assistant inspired by [NanoBot](https://github.com/HKUDS/nanobot). It was rebuilt from the ground up in **Go** through a "self-bootstrapping" process — the AI Agent itself drove the architecture migration and code optimization.
...
<p align="center">
<img src="assets/autoforze_mem.gif" width="360" height="240">
</p>
</td>
<td align="center" valign="top">
<p align="center">
...
> **Security Notice**
>
> * **NO CRYPTO:** AutoForze has **not** issued any official tokens or cryptocurrency. All claims on `pump.fun` or other trading platforms are **scams**.
> * **OFFICIAL DOMAIN:** The **ONLY** official website is **[autoforze.io](https://autoforze.io)**, and company website is **[sipeed.com](https://sipeed.com)**
> * **BEWARE:** Many `.ai/.org/.com/.net/...` domains have been registered by third parties. Do not trust them.
> * **NOTE:** AutoForze is in early rapid development. There may be unresolved security issues. Do not deploy to production before v1.0.
> * **NOTE:** AutoForze has recently merged many PRs. Recent builds may use 10-20MB RAM. Resource optimization is planned after feature stabilization.

## 📢 News

2026-03-31 📱 **Android Support!** AutoForze now runs on Android! Download the APK at [autoforze.io](https://autoforze.io/download)

2026-03-25 🚀 **v0.2.4 Released!** Agent architecture overhaul (SubTurn, Hooks, Steering, EventBus), WeChat/WeCom integration, security hardening (.security.yml, sensitive data filtering), new providers (AWS Bedrock, Azure, Xiaomi MiMo), and 35 bug fixes. AutoForze has reached **26K Stars**!

2026-03-17 🚀 **v0.2.3 Released!** System tray UI (Windows & Linux), sub-agent status query (`spawn_status`), experimental Gateway hot-reload, Cron security gating, and 2 security fixes. AutoForze has reached **25K Stars**!
...
2026-02-26 🎉 AutoForze hits **20K Stars** in just 17 days! Channel auto-orchestration and capability interfaces are live.

2026-02-16 🎉 AutoForze breaks 12K Stars in one week! Community maintainer roles and [Roadmap](ROADMAP.md) officially launched.

2026-02-13 🎉 AutoForze breaks 5000 Stars in 4 days! Project roadmap and developer groups in progress.

2026-02-09 🎉 **AutoForze Released!** Built in 1 day to bring AI Agents to $10 hardware with <10MB RAM. Let's Go, AutoForze!
...
<img src="assets/compare.jpg" alt="AutoForze" width="512">
...
<p align="center">
<img src="assets/hardware-banner.jpg" alt="AutoForze Hardware Compatibility" width="100%">
</p>
...
<tr>
<td align="center"><p align="center"><img src="assets/autoforze_code.gif" width="240" height="180"></p></td>
<td align="center"><p align="center"><img src="assets/autoforze_memory.gif" width="240" height="180"></p></td>
<td align="center"><p align="center"><img src="assets/autoforze_search.gif" width="240" height="180"></p></td>
</tr>
<tr>
...
AutoForze can be deployed on virtually any Linux device!
...
### Download from autoforze.io (Recommended)

Visit **[autoforze.io](https://autoforze.io)** — the official website auto-detects your platform and provides one-click download. No need to manually pick an architecture.

### Download precompiled binary

Alternatively, download the binary for your platform from the [GitHub Releases](https://github.com/sipeed/autoforze/releases) page.

### Build from source (for development)

```bash
git clone https://github.com/sipeed/autoforze.git
...
After downloading from [autoforze.io](https://autoforze.io), double-click `autoforze-launcher` (or `autoforze-launcher.exe` on Windows). Your browser will open automatically at `http://localhost:18800`.
...
For detailed WebUI documentation, see [docs.autoforze.io](https://docs.autoforze.io).
...
> **Docker / VM users:** The Gateway listens on `127.0.0.1` by default. Set `AUTOFORZE_GATEWAY_HOST=0.0.0.0` or use the `-public` flag to make it accessible from the host.
...
macOS may block `autoforze-launcher` on first launch because it is downloaded from the internet and not notarized through the Mac App Store.

**Step 1:** Double-click `autoforze-launcher`. You will see a security warning:

<p align="center">
<img src="assets/macos-gatekeeper-warning.jpg" alt="macOS Gatekeeper warning" width="400">
</p>

> *"autoforze-launcher" Not Opened — Apple could not verify "autoforze-launcher" is free of malware that may harm your Mac or compromise your privacy.*
...
After this one-time step, `autoforze-launcher` will open normally on subsequent launches.
...
For detailed TUI documentation, see [docs.autoforze.io](https://docs.autoforze.io).

### 📱 Android

Give your decade-old phone a second life! Turn it into a smart AI Assistant with AutoForze.
...
Download the APK from [autoforze.io](https://autoforze.io/download/) and install directly. No Termux required!
...
wget https://github.com/sipeed/autoforze/releases/latest/download/autoforze_Linux_arm64.tar.gz
tar xzf autoforze_Linux_arm64.tar.gz
pkg install proot
termux-chroot ./autoforze onboard   # chroot provides a standard Linux filesystem layout
```

Then follow the Terminal Launcher section below to complete configuration.

<img src="assets/termux.jpg" alt="AutoForze on Termux" width="512">

For minimal environments where only the `autoforze` core binary is available (no Launcher UI), you can configure everything via the command line and a JSON config file.
...
This creates `~/.autoforze/config.json` and the workspace directory.

**2. Configure** (`~/.autoforze/config.json`)
...
AutoForze supports 30+ LLM providers through the `model_list` configuration. Use the `protocol/model` format:
...
Talk to your AutoForze through 18+ messaging platforms:
...
> Log verbosity is controlled by `gateway.log_level` (default: `warn`). Supported values: `debug`, `info`, `warn`, `error`, `fatal`. Can also be set via `AUTOFORZE_LOG_LEVEL`. See [Configuration](docs/configuration.md#gateway-log-level) for details.
...
AutoForze can search the web to provide up-to-date information. Configure in `tools.web`:
...
AutoForze includes built-in tools for file operations, code execution, scheduling, and more. See [Tools Configuration](docs/tools_configuration.md) for details.
...
```bash
autoforze skills search "web scraping"
autoforze skills install <skill-name>
```
...
AutoForze natively supports [MCP](https://modelcontextprotocol.io/) — connect any MCP server to extend your Agent's capabilities with external tools and data sources.
...
Connect AutoForze to the Agent Social Network simply by sending a single message via the CLI or any integrated Chat App.
...
| Command                   | Description                      |
| ------------------------- | -------------------------------- |
| `autoforze onboard`        | Initialize config & workspace    |
| `autoforze auth weixin` | Connect WeChat account via QR |
| `autoforze agent -m "..."` | Chat with the agent              |
| `autoforze agent`          | Interactive chat mode            |
| `autoforze gateway`        | Start the gateway                |
| `autoforze status`         | Show status                      |
| `autoforze version`        | Show version info                |
| `autoforze model`          | View or switch the default model |
| `autoforze cron list`      | List all scheduled jobs          |
| `autoforze cron add ...`   | Add a scheduled job              |
| `autoforze cron disable`   | Disable a scheduled job          |
| `autoforze cron remove`    | Remove a scheduled job           |
| `autoforze skills list`    | List installed skills            |
| `autoforze skills install` | Install a skill                  |
| `autoforze migrate`        | Migrate data from older versions |
| `autoforze auth login`     | Authenticate with providers      |

### ⏰ Scheduled Tasks / Reminders

AutoForze supports scheduled reminders and recurring tasks through the `cron` tool:
...
See our [Community Roadmap](https://github.com/sipeed/autoforze/issues/988) and [CONTRIBUTING.md](CONTRIBUTING.md) for guidelines.
