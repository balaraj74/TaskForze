...
import (
	...
	tuicfg "github.com/sipeed/autoforze/cmd/autoforze-launcher-tui/config"
	"github.com/sipeed/autoforze/cmd/autoforze-launcher-tui/ui"
)
...
func main() {
	...
	if _, err := os.Stat(configDir); os.IsNotExist(err) {
		cmd := exec.Command("autoforze", "onboard")
		cmd.Stdin = os.Stdin
	...
	if err != nil {
		fmt.Fprintf(os.Stderr, "autoforze-launcher-tui: %v\n", err)
		os.Exit(1)
	}
