...
func (a *App) newHomePage() tview.Primitive {
	...
	rebuildList := func() {
		...
		list.AddItem("QUIT SYSTEM", "Exit AutoForze Launcher", 'q', func() { a.tapp.Stop() })
