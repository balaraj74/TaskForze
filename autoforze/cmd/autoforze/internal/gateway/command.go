...
import (
	...
	"github.com/sipeed/autoforze/pkg/gateway"
...
func NewGatewayCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(_ *cobra.Command, _ []string) error {
			return gateway.Run(debug, internal.GetAutoforzeHome(), internal.GetConfigPath(), allowEmpty)
		},
	}
