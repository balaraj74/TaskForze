...
Examples:
  autoforze model                    # Show current default model
  autoforze model gpt-5.2           # Set gpt-5.2 as default
  autoforze model claude-sonnet-4.6 # Set claude-sonnet-4.6 as default
  autoforze model local-model       # Set local VLLM server as default
